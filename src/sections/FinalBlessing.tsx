        ...
        >
          ...
          <div className="relative grid gap-8 md:grid-cols-[minmax(0,1fr)_15rem] md:items-end">
            <div>
              ...
              >
                Бул Курман айт үйүңүздөргө таттуулук, жүрөгүңүздөргө сабыр, дасторконуңуздарга береке жана
                ар бир жаңы күнүңүздөргө мээрим алып келсин. Курмандык ниетиңиздер кабыл болуп,
                жакындарыңыздар менен бөлүшкөн ар бир кубаныч узак жылуулук болуп сакталсын.
              </p>
              <p
                data-final-line
